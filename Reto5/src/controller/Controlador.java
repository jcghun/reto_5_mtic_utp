...
public class Controlador implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == view.btnInforme1){
            String[] titulo =new String[] {"ID de Lider","Nombre","Apellido","Ciudad de Residencia"};
        ...
        if (e.getSource() == view.btnInforme2){
            String[] titulo =new String[] {"ID de Proyecto","Constructora","Numero de Habitaciones","Ciudad"};
            view.mostrar.setColumnIdentifiers(titulo);
            view.mostrar.setNumRows(0);
        ...
        if (e.getSource() == view.btnInforme3){
            String[] titulo =new String[] {"ID de Compra","Constructora","Banco Vinculado"};
            view.mostrar.setColumnIdentifiers(titulo);
            view.mostrar.setNumRows(0);
